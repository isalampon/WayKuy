  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const recommendQuery = query(collection(db, 'Services'), where('isRecommend', '==', true));
        ...
        // ดึงข้อมูล Mosques
        const mosqueQuery = query(collection(db, 'Services'), where('category', '==', 'Mosque'));
        ...
        const touristQuery = query(collection(db, 'Services'), where('category', '==', 'Tourist attraction'));
        ...
        const prayerQuery = query(collection(db, 'Services'), where('category', '==', 'Prayer Space'));
        ...
        {user ? (
          ...
          <View style={styles.userSection}>
            ...
            <View style={styles.userActions}>
              ...
              <TouchableOpacity style={styles.iconButton} onPress={() => signOut(FIREBASE_AUTH)}>
